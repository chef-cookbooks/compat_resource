    ...
    module CopiedFromChef
      ...
      class Chef < (defined?(::Chef) ? ::Chef : Object)
        class Resource < (defined?(::Chef::Resource) ? ::Chef::Resource : Object)
          ...
          alias state state_for_resource_reporter
          def identity
            result = {}
          ...
          def self.identity_property(name = nil)
            ...
            if result.size > 1
              fail Chef::Exceptions::MultipleIdentityError, "identity_property cannot be called on an object with more than one identity property (#{result.map(&:name).join(', ')})."
            end
            result.first
          end
          attr_accessor :allowed_actions
          def allowed_actions(value = NOT_PASSED)
            self.allowed_actions = value if value != NOT_PASSED
            @allowed_actions
          end
          ...
          FORBIDDEN_IVARS = [:@run_context, :@not_if, :@only_if, :@enclosing_provider].freeze
          HIDDEN_IVARS = [:@allowed_actions, :@resource_name, :@source_line, :@run_context, :@name, :@not_if, :@only_if, :@elapsed_time, :@enclosing_provider].freeze
          class << self
          end
